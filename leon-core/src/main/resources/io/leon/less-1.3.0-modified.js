...
/* !!! MODIFIED version of loadStyleSheet to make use of Leon's resource loading mechanism !!! */
function loadStyleSheet(sheet, callback, reload, remaining) {
    ...
    // print("loadStyleSheet: " + sheet.href + "; originalLessFilePath is " + originalLessFilePath);
    ...
    parser.parse(lessString, function (e, root) {
        ...
        callback(e, root, lessString, sheet, { local: true, lastModified: new Date(resource.getLastModified()), remaining: remaining });
    });
